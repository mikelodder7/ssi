...
pub enum Error {
    ...
    ControllerMismatch(String, String),
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Error::ControllerMismatch(expected, actual) => write!(f, "Verification method controller does not match issuer/holder. Expected: {}. Actual: {}", expected, actual),
            ...
            Error::ControllerDepth => write!(f, "DID controller depth limit exceeded"),
